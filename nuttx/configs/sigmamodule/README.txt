...
=======
  ...
  ----
    ...
    ----------------------
      CONFIG_SAML21_SIGMAMODULE_IOMODULE=y      : Informs the system that the
                                              I/O1 module is installed
      CONFIG_SAML21_SIGMAMODULE_IOMODULE_EXT1=y : The module is installed in EXT1
      CONFIG_SAML21_SIGMAMODULE_IOMODULE_EXT2=y : The mdoule is installed in EXT2
  ...
  -----
    ...
    Configuration Options:
    ----------------------
      CONFIG_SAML21_SIGMAMODULE_OLED1MODULE=y      : Informs the system that the
                                                 I/O1 module is installed
      CONFIG_SAML21_SIGMAMODULE_OLED1MODULE_EXT1=y : The module is installed in EXT1
      CONFIG_SAML21_SIGMAMODULE_OLED1MODULE_EXT2=y : The mdoule is installed in EXT2
...
================================
  ...
  1. You must have already configured Nuttx in <some-dir>/nuttx.
     ...
     cd tools
     ./configure.sh sigmamodule/<sub-dir>
...
===============
  ...
  connector SERCOM4 is on:  SAML21_SIGMAMODULE_USART4_EXTn, where n=1, 2, or 3.
...
==================================================
    ...
    CONFIG_ARCH_BOARD - Identifies the configs subdirectory and
       ...
       CONFIG_ARCH_BOARD="sigmamodule" (for the SAML21 Xplained Pro development board)

    CONFIG_ARCH_BOARD_name - For use in C code

       CONFIG_ARCH_BOARD_SAML21_SIGMAMODULE=y
...
==============
  ...
  can be selected as follow:
    ...
    cd tools
    ./configure.sh sigmamodule/<subdir>
    cd -
    . ./setenv.sh
  ...
  nsh:
    ...
    4. WARNING: This info comes from the SAMD20 Xplained README.  I have
       ...
       Board Selection -> SAML21 Xplained Pro Modules
         CONFIG_SAML21_SIGMAMODULE_IOMODULE=y      : I/O1 module is connected
         CONFIG_SAML21_SIGMAMODULE_IOMODULE_EXT2=y : I/O1 modules is in EXT2
    ...
    5. If the OLED1 module is connected to the SAML21 Xplained Pro, then
       ...
       Board Selection -> SAML21 Xplained Pro Modules
         CONFIG_SAML21_SIGMAMODULE_OLED1MODULE=y      : OLED1 module is connected
         CONFIG_SAML21_SIGMAMODULE_OLED1MODULE_EXT2=y : OLED1 modules is in EXT2
